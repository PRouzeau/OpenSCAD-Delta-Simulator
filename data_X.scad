...
//  - add alternatives for arm length
Delta_name = "X";
housing_base=0; // no housing
housing_opening = 200; // defines height of the opening in the housing

beam_int_radius = 320; // radius on rod axis plane - used as reference radius
hbase = 47; // height of the base structure 
htop  = 16;  // height of top structure
htotal= 1700; // total height, including base and top structure

bed_level = 9; 
extrusion = 20; // Rod diameter
rod_space = 80; // set two rods instead of one extrusion
...
eff_hor_offset= 45; 
eff_vert_dist = 4.5; 
arm_space= 80; // space between the arms
wire_space=57;

//*delta_angle = 61.55; 
arm_length = 520; // supersedes delta_angle  
mini_angle = 22; // gives height 160/180 - that is a too low angle - did not work well for large diameters */
...
$bedDia=500; // force the bed diameter
